...
{  (version 1.11, file date 05.07.2016 8:32:56 GMT) }
...
const
  OneByteSyntaxes: array[0..612]of TOpcodeSyntax = (
   ...
   {98_2}
    (Base:173; Count:2; Mnem:oc_CBW),
    (Base:175; Count:2; Mnem:oc_CWDE),
    (Base:177; Count:2; Mnem:oc_CDQE),
   {99_0}
    (Base:179; Count:2; Mnem:oc_CWD),
   {99_1}
    (Base:181; Count:2; Mnem:oc_CDQ),
   {99_2}
    (Base:179; Count:2; Mnem:oc_CWD),
    (Base:181; Count:2; Mnem:oc_CDQ),
    (Base:183; Count:2; Mnem:oc_CQO),
   {9A_0}
    (Base:185; Count:2; Mnem:oc_CALLF),
   {9B_0}
    (Mnem:oc_FWAIT),
    (Mnem:oc_WAIT),
   {9C_0}
    (Base:187; Count:2; Mnem:oc_PUSHF),
   {9C_1}
    (Base:189; Count:2; Mnem:oc_PUSHFD),
   {9C_2}
    (Base:191; Count:2; Mnem:oc_PUSHF),
    (Base:193; Count:2; Mnem:oc_PUSHFQ),
   {9D_0}
    (Base:195; Count:2; Mnem:oc_POPF),
   {9D_1}
    (Base:197; Count:2; Mnem:oc_POPFD),
   {9D_2}
    (Base:199; Count:2; Mnem:oc_POPF),
    (Base:201; Count:2; Mnem:oc_POPFQ),
   {9E_0}
    (Base:203; Count:1; Mnem:oc_SAHF),
   {9F_0}
    (Base:204; Count:1; Mnem:oc_LAHF),
   {A0_0}
    (Base:205; Count:2; Mnem:oc_MOV),
   {A1_0}
    (Base:207; Count:2; Mnem:oc_MOV),
   {A2_0}
    (Base:209; Count:2; Mnem:oc_MOV),
   {A3_0}
    (Base:211; Count:2; Mnem:oc_MOV),
   {A4_0}
    (Base:213; Count:2; Mnem:oc_MOVS),
    (Base:215; Count:2; Mnem:oc_MOVSB),
   {A5_0}
    (Base:217; Count:2; Mnem:oc_MOVS),
    (Base:219; Count:2; Mnem:oc_MOVSW),
   {A5_1}
    (Base:221; Count:2; Mnem:oc_MOVS),
    (Base:223; Count:2; Mnem:oc_MOVSD),
   {A5_2}
    (Base:225; Count:2; Mnem:oc_MOVS),
    (Base:227; Count:2; Mnem:oc_MOVSW),
    (Base:229; Count:2; Mnem:oc_MOVSD),
    (Base:231; Count:2; Mnem:oc_MOVSQ),
   {A6_0}
    (Base:233; Count:2; Mnem:oc_CMPS),
    (Base:235; Count:2; Mnem:oc_CMPSB),
   {A7_0}
    (Base:237; Count:2; Mnem:oc_CMPS),
    (Base:239; Count:2; Mnem:oc_CMPSW),
   {A7_1}
    (Base:241; Count:2; Mnem:oc_CMPS),
    (Base:243; Count:2; Mnem:oc_CMPSD),
   {A7_2}
    (Base:245; Count:2; Mnem:oc_CMPS),
    (Base:247; Count:2; Mnem:oc_CMPSW),
    (Base:249; Count:2; Mnem:oc_CMPSD),
    (Base:251; Count:2; Mnem:oc_CMPSQ),
   {A8_0}
    (Base:42; Count:2; Mnem:oc_TEST),
   {A9_0}
    (Base:44; Count:2; Mnem:oc_TEST),
   {AA_0}
    (Base:253; Count:2; Mnem:oc_STOS),
    (Base:255; Count:2; Mnem:oc_STOSB),
   {AB_0}
    (Base:257; Count:2; Mnem:oc_STOS),
    (Base:259; Count:2; Mnem:oc_STOSW),
   {AB_1}
    (Base:261; Count:2; Mnem:oc_STOS),
    (Base:263; Count:2; Mnem:oc_STOSD),
   {AB_2}
    (Base:265; Count:2; Mnem:oc_STOS),
    (Base:267; Count:2; Mnem:oc_STOSW),
    (Base:269; Count:2; Mnem:oc_STOSD),
    (Base:271; Count:2; Mnem:oc_STOSQ),
   {AC_0}
    (Base:273; Count:2; Mnem:oc_LODS),
    (Base:275; Count:2; Mnem:oc_LODSB),
   {AD_0}
    (Base:277; Count:2; Mnem:oc_LODS),
    (Base:279; Count:2; Mnem:oc_LODSW),
   {AD_1}
    (Base:281; Count:2; Mnem:oc_LODS),
    (Base:283; Count:2; Mnem:oc_LODSD),
   {AD_2}
    (Base:285; Count:2; Mnem:oc_LODS),
    (Base:287; Count:2; Mnem:oc_LODSW),
    (Base:289; Count:2; Mnem:oc_LODSD),
    (Base:291; Count:2; Mnem:oc_LODSQ),
   {AE_0}
    (Base:293; Count:2; Mnem:oc_SCAS),
    (Base:295; Count:2; Mnem:oc_SCASB),
   {AF_0}
    (Base:297; Count:2; Mnem:oc_SCAS),
    (Base:299; Count:2; Mnem:oc_SCASW),
   {AF_1}
    (Base:301; Count:2; Mnem:oc_SCAS),
    (Base:303; Count:2; Mnem:oc_SCASD),
   {AF_2}
    (Base:305; Count:2; Mnem:oc_SCAS),
    (Base:307; Count:2; Mnem:oc_SCASW),
    (Base:309; Count:2; Mnem:oc_SCASD),
    (Base:311; Count:2; Mnem:oc_SCASQ),
   {B0_0}
    (Base:313; Count:2; Mnem:oc_MOV),
   {B8_0}
    (Base:315; Count:2; Mnem:oc_MOV),
   {C0_0}
   ...
   {C1_0}
    (Base:317; Count:2; Mnem:oc_ROL),
   {C1_1}
    (Base:317; Count:2; Mnem:oc_ROR),
   {C1_2}
    (Base:317; Count:2; Mnem:oc_RCL),
   {C1_3}
    (Base:317; Count:2; Mnem:oc_RCR),
   {C1_4}
    (Base:317; Count:2; Mnem:oc_SHL),
    (Base:317; Count:2; Mnem:oc_SAL),
   {C1_5}
    (Base:317; Count:2; Mnem:oc_SHR),
   {C1_6}
    (Base:317; Count:2; Mnem:oc_SAL),
    (Base:317; Count:2; Mnem:oc_SHL),
   {C1_7}
    (Base:317; Count:2; Mnem:oc_SAR),
   {C2_0}
    (Base:319; Count:2; Mnem:oc_RETN),
   {C3_0}
    (Base:321; Count:1; Mnem:oc_RETN),
   {C4_0}
    (Base:322; Count:3; Mnem:oc_LES),
   {C5_0}
    (Base:325; Count:3; Mnem:oc_LDS),
   {C6_0}
    (Base:328; Count:2; Mnem:oc_MOV),
   {C7_0}
    (Base:330; Count:2; Mnem:oc_MOV),
   {C8_0}
    (Base:332; Count:4; Mnem:oc_ENTER),
   {C8_1}
    (Base:336; Count:4; Mnem:oc_ENTER),
   {C9_0}
    (Base:340; Count:2; Mnem:oc_LEAVE),
   {C9_1}
    (Base:342; Count:2; Mnem:oc_LEAVE),
   {CA_0}
    (Base:344; Count:2; Mnem:oc_RETF),
   {CB_0}
    (Base:321; Count:1; Mnem:oc_RETF),
   {CC_0}
    (Base:346; Count:3; Mnem:oc_INT),
   {CD_0}
    (Base:349; Count:3; Mnem:oc_INT),
   {CE_0}
    (Base:352; Count:2; Mnem:oc_INTO),
   {CF_0}
    (Base:354; Count:2; Mnem:oc_IRET),
   {CF_1}
    (Base:356; Count:2; Mnem:oc_IRETD),
   {CF_2}
    (Base:354; Count:2; Mnem:oc_IRET),
    (Base:356; Count:2; Mnem:oc_IRETD),
    (Base:358; Count:2; Mnem:oc_IRETQ),
   {D0_0}
    (Base:360; Count:2; Mnem:oc_ROL),
   {D0_1}
    (Base:360; Count:2; Mnem:oc_ROR),
   {D0_2}
    (Base:360; Count:2; Mnem:oc_RCL),
   {D0_3}
    (Base:360; Count:2; Mnem:oc_RCR),
   {D0_4}
    (Base:360; Count:2; Mnem:oc_SHL),
    (Base:360; Count:2; Mnem:oc_SAL),
   {D0_5}
    (Base:360; Count:2; Mnem:oc_SHR),
   {D0_6}
    (Base:360; Count:2; Mnem:oc_SAL),
    (Base:360; Count:2; Mnem:oc_SHL),
   {D0_7}
    (Base:360; Count:2; Mnem:oc_SAR),
   {D1_0}
    (Base:362; Count:2; Mnem:oc_ROL),
   {D1_1}
    (Base:362; Count:2; Mnem:oc_ROR),
   {D1_2}
    (Base:362; Count:2; Mnem:oc_RCL),
   {D1_3}
    (Base:362; Count:2; Mnem:oc_RCR),
   {D1_4}
    (Base:362; Count:2; Mnem:oc_SHL),
    (Base:362; Count:2; Mnem:oc_SAL),
   {D1_5}
    (Base:362; Count:2; Mnem:oc_SHR),
   {D1_6}
    (Base:362; Count:2; Mnem:oc_SAL),
    (Base:362; Count:2; Mnem:oc_SHL),
   {D1_7}
    (Base:362; Count:2; Mnem:oc_SAR),
   {D2_0}
    (Base:364; Count:2; Mnem:oc_ROL),
   {D2_1}
    (Base:364; Count:2; Mnem:oc_ROR),
   {D2_2}
    (Base:364; Count:2; Mnem:oc_RCL),
   {D2_3}
    (Base:364; Count:2; Mnem:oc_RCR),
   {D2_4}
    (Base:364; Count:2; Mnem:oc_SHL),
    (Base:364; Count:2; Mnem:oc_SAL),
   {D2_5}
    (Base:364; Count:2; Mnem:oc_SHR),
   {D2_6}
    (Base:364; Count:2; Mnem:oc_SAL),
    (Base:364; Count:2; Mnem:oc_SHL),
   {D2_7}
    (Base:364; Count:2; Mnem:oc_SAR),
   {D3_0}
   ...
   {D4_0}
    (Base:368; Count:2; Mnem:oc_AAM),
   {D4_1}
    (Base:370; Count:3; Mnem:oc_AMX),
   {D5_0}
    (Base:32; Count:2; Mnem:oc_AAD),
   {D5_1}
    (Base:373; Count:3; Mnem:oc_ADX),
   {D6_1}
    (Base:376; Count:1; Mnem:oc_SALC),
    (Base:376; Count:1; Mnem:oc_SETALC),
   {D7_0}
    (Base:377; Count:2; Mnem:oc_XLAT),
    (Base:379; Count:2; Mnem:oc_XLATB),
   {D8_0}
    (Base:381; Count:2; Mnem:oc_FADD),
    (Base:383; Count:2; Mnem:oc_FADD),
   {D8_1}
    (Base:381; Count:2; Mnem:oc_FMUL),
    (Base:383; Count:2; Mnem:oc_FMUL),
   {D8_2}
    (Base:385; Count:2; Mnem:oc_FCOM),
   {D8_3}
    (Base:387; Count:2; Mnem:oc_FCOM),
   {D8_4}
    (Base:385; Count:2; Mnem:oc_FCOMP),
   {D8_5}
    (Base:387; Count:2; Mnem:oc_FCOMP),
   {D8_6}
    (Base:381; Count:2; Mnem:oc_FSUB),
    (Base:383; Count:2; Mnem:oc_FSUB),
   {D8_7}
    (Base:381; Count:2; Mnem:oc_FSUBR),
    (Base:383; Count:2; Mnem:oc_FSUBR),
   {D8_8}
    (Base:381; Count:2; Mnem:oc_FDIV),
    (Base:383; Count:2; Mnem:oc_FDIV),
   {D8_9}
    (Base:381; Count:2; Mnem:oc_FDIVR),
    (Base:383; Count:2; Mnem:oc_FDIVR),
   {D9_0}
    (Base:389; Count:2; Mnem:oc_FLD),
   {D9_1}
    (Base:391; Count:2; Mnem:oc_FXCH),
   {D9_2}
    (Base:393; Count:2; Mnem:oc_FXCH),
   {D9_3}
    (Base:395; Count:2; Mnem:oc_FST),
   {D9_4}
    (Mnem:oc_FNOP),
   {D9_5}
    (Base:395; Count:2; Mnem:oc_FSTP),
   {D9_6}
    (Base:397; Count:2; Mnem:oc_FSTP1),
   {D9_7}
    (Base:397; Count:2; Mnem:oc_FSTP1),
   {D9_8}
    (Base:399; Count:1; Mnem:oc_FLDENV),
   {D9_9}
    (Base:400; Count:1; Mnem:oc_FCHS),
   {D9_10}
    (Base:400; Count:1; Mnem:oc_FABS),
   {D9_11}
    (Base:401; Count:1; Mnem:oc_FTST),
   {D9_12}
    (Base:401; Count:1; Mnem:oc_FXAM),
   {D9_13}
    (Base:402; Count:1; Mnem:oc_FLDCW),
   {D9_14}
    (Base:400; Count:1; Mnem:oc_FLD1),
   {D9_15}
    (Base:400; Count:1; Mnem:oc_FLDL2T),
   {D9_16}
    (Base:400; Count:1; Mnem:oc_FLDL2E),
   {D9_17}
    (Base:400; Count:1; Mnem:oc_FLDPI),
   {D9_18}
    (Base:400; Count:1; Mnem:oc_FLDLG2),
   {D9_19}
    (Base:400; Count:1; Mnem:oc_FLDLN2),
   {D9_20}
    (Base:400; Count:1; Mnem:oc_FLDZ),
   {D9_21}
    (Base:403; Count:1; Mnem:oc_FNSTENV),
   {D9_22}
    (Base:403; Count:1; Mnem:oc_FSTENV),
   {D9_23}
    (Base:400; Count:1; Mnem:oc_F2XM1),
   {D9_24}
    (Base:404; Count:2; Mnem:oc_FYL2X),
   {D9_25}
    (Base:400; Count:1; Mnem:oc_FPTAN),
   {D9_26}
    (Base:404; Count:2; Mnem:oc_FPATAN),
   {D9_27}
    (Base:400; Count:1; Mnem:oc_FXTRACT),
   {D9_28}
    (Base:406; Count:2; Mnem:oc_FPREM1),
   {D9_29}
    (Mnem:oc_FDECSTP),
   {D9_30}
    (Mnem:oc_FINCSTP),
   {D9_31}
    (Base:408; Count:1; Mnem:oc_FNSTCW),
   {D9_32}
    (Base:408; Count:1; Mnem:oc_FSTCW),
   {D9_33}
    (Base:406; Count:2; Mnem:oc_FPREM),
   {D9_34}
    (Base:404; Count:2; Mnem:oc_FYL2XP1),
   {D9_35}
    (Base:400; Count:1; Mnem:oc_FSQRT),
   {D9_36}
    (Base:400; Count:1; Mnem:oc_FSINCOS),
   {D9_37}
    (Base:400; Count:1; Mnem:oc_FRNDINT),
   {D9_38}
    (Base:406; Count:2; Mnem:oc_FSCALE),
   {D9_39}
    (Base:400; Count:1; Mnem:oc_FSIN),
   {D9_40}
    (Base:400; Count:1; Mnem:oc_FCOS),
   {DA_0}
    (Base:409; Count:2; Mnem:oc_FIADD),
   {DA_1}
    (Base:383; Count:2; Mnem:oc_FCMOVB),
   {DA_2}
    (Base:409; Count:2; Mnem:oc_FIMUL),
   {DA_3}
    (Base:383; Count:2; Mnem:oc_FCMOVE),
   {DA_4}
    (Base:411; Count:2; Mnem:oc_FICOM),
   {DA_5}
    (Base:383; Count:2; Mnem:oc_FCMOVBE),
   {DA_6}
    (Base:411; Count:2; Mnem:oc_FICOMP),
   {DA_7}
    (Base:383; Count:2; Mnem:oc_FCMOVU),
   {DA_8}
    (Base:409; Count:2; Mnem:oc_FISUB),
   {DA_9}
    (Base:409; Count:2; Mnem:oc_FISUBR),
   {DA_10}
    (Base:413; Count:2; Mnem:oc_FUCOMPP),
   {DA_11}
    (Base:409; Count:2; Mnem:oc_FIDIV),
   {DA_12}
    (Base:409; Count:2; Mnem:oc_FIDIVR),
   {DB_0}
    (Base:409; Count:2; Mnem:oc_FILD),
   {DB_1}
    (Base:383; Count:2; Mnem:oc_FCMOVNB),
   {DB_2}
    (Base:415; Count:2; Mnem:oc_FISTTP),
   {DB_3}
    (Base:383; Count:2; Mnem:oc_FCMOVNE),
   {DB_4}
    (Base:415; Count:2; Mnem:oc_FIST),
   {DB_5}
    (Base:383; Count:2; Mnem:oc_FCMOVNBE),
   {DB_6}
    (Base:415; Count:2; Mnem:oc_FISTP),
   {DB_7}
    (Base:383; Count:2; Mnem:oc_FCMOVNU),
   {DB_8}
    (Mnem:oc_FNENI),
   {DB_9}
    (Mnem:oc_FENI),
   ...
   {DB_20}
    (Mnem:oc_FNSETPM),
   {DB_21}
    (Base:417; Count:2; Mnem:oc_FLD),
   {DB_22}
    (Base:419; Count:2; Mnem:oc_FUCOMI),
   {DB_23}
    (Base:419; Count:2; Mnem:oc_FCOMI),
   {DB_24}
    (Base:421; Count:2; Mnem:oc_FSTP),
   {DC_0}
    (Base:423; Count:2; Mnem:oc_FADD),
   {DC_1}
    (Base:425; Count:2; Mnem:oc_FADD),
   {DC_2}
    (Base:423; Count:2; Mnem:oc_FMUL),
   {DC_3}
    (Base:425; Count:2; Mnem:oc_FMUL),
   {DC_4}
    (Base:427; Count:2; Mnem:oc_FCOM),
   {DC_5}
    (Base:429; Count:2; Mnem:oc_FCOM2),
   {DC_6}
    (Base:429; Count:2; Mnem:oc_FCOM2),
   {DC_7}
    (Base:427; Count:2; Mnem:oc_FCOMP),
   {DC_8}
    (Base:429; Count:2; Mnem:oc_FCOMP3),
   {DC_9}
    (Base:429; Count:2; Mnem:oc_FCOMP3),
   {DC_10}
    (Base:423; Count:2; Mnem:oc_FSUB),
   {DC_11}
    (Base:425; Count:2; Mnem:oc_FSUBR),
   {DC_12}
    (Base:423; Count:2; Mnem:oc_FSUBR),
   {DC_13}
    (Base:425; Count:2; Mnem:oc_FSUB),
   {DC_14}
    (Base:423; Count:2; Mnem:oc_FDIV),
   {DC_15}
    (Base:425; Count:2; Mnem:oc_FDIVR),
   {DC_16}
    (Base:423; Count:2; Mnem:oc_FDIVR),
   {DC_17}
    (Base:425; Count:2; Mnem:oc_FDIV),
   {DD_0}
    (Base:423; Count:2; Mnem:oc_FLD),
   {DD_1}
    (Base:431; Count:1; Mnem:oc_FFREE),
   {DD_2}
    (Base:432; Count:2; Mnem:oc_FISTTP),
   {DD_3}
    (Base:391; Count:2; Mnem:oc_FXCH4),
   {DD_4}
    (Base:391; Count:2; Mnem:oc_FXCH4),
   {DD_5}
    (Base:434; Count:2; Mnem:oc_FST),
   {DD_6}
    (Base:436; Count:2; Mnem:oc_FST),
   {DD_7}
    (Base:434; Count:2; Mnem:oc_FSTP),
   {DD_8}
    (Base:436; Count:2; Mnem:oc_FSTP),
   {DD_9}
    (Base:438; Count:9; Mnem:oc_FRSTOR),
   {DD_10}
    (Base:429; Count:2; Mnem:oc_FUCOM),
   {DD_11}
    (Base:387; Count:2; Mnem:oc_FUCOM),
   {DD_12}
    (Base:429; Count:2; Mnem:oc_FUCOMP),
   {DD_13}
    (Base:387; Count:2; Mnem:oc_FUCOMP),
   {DD_14}
    (Base:447; Count:9; Mnem:oc_FNSAVE),
   {DD_15}
    (Base:447; Count:9; Mnem:oc_FSAVE),
   {DD_16}
    (Base:456; Count:1; Mnem:oc_FNSTSW),
   {DD_17}
    (Base:456; Count:1; Mnem:oc_FSTSW),
   {DE_0}
    (Base:457; Count:2; Mnem:oc_FIADD),
   {DE_1}
    (Base:425; Count:2; Mnem:oc_FADDP),
   {DE_2}
    (Base:459; Count:2; Mnem:oc_FADDP),
   {DE_3}
    (Base:457; Count:2; Mnem:oc_FIMUL),
   {DE_4}
    (Base:425; Count:2; Mnem:oc_FMULP),
   {DE_5}
    (Base:459; Count:2; Mnem:oc_FMULP),
   {DE_6}
    (Base:461; Count:2; Mnem:oc_FICOM),
   {DE_7}
    (Base:429; Count:2; Mnem:oc_FCOMP5),
   {DE_8}
    (Base:429; Count:2; Mnem:oc_FCOMP5),
   {DE_9}
    (Base:461; Count:2; Mnem:oc_FICOMP),
   {DE_10}
    (Base:413; Count:2; Mnem:oc_FCOMPP),
   {DE_11}
    (Base:457; Count:2; Mnem:oc_FISUB),
   {DE_12}
    (Base:425; Count:2; Mnem:oc_FSUBRP),
   {DE_13}
    (Base:459; Count:2; Mnem:oc_FSUBRP),
   {DE_14}
    (Base:457; Count:2; Mnem:oc_FISUBR),
   {DE_15}
    (Base:425; Count:2; Mnem:oc_FSUBP),
   {DE_16}
    (Base:459; Count:2; Mnem:oc_FSUBP),
   {DE_17}
    (Base:457; Count:2; Mnem:oc_FIDIV),
   {DE_18}
    (Base:425; Count:2; Mnem:oc_FDIVRP),
   {DE_19}
    (Base:459; Count:2; Mnem:oc_FDIVRP),
   {DE_20}
    (Base:457; Count:2; Mnem:oc_FIDIVR),
   {DE_21}
    (Base:425; Count:2; Mnem:oc_FDIVP),
   {DE_22}
    (Base:459; Count:2; Mnem:oc_FDIVP),
   {DF_0}
    (Base:457; Count:2; Mnem:oc_FILD),
   {DF_1}
    (Base:431; Count:1; Mnem:oc_FFREEP),
   {DF_2}
    (Base:463; Count:2; Mnem:oc_FISTTP),
   {DF_3}
    (Base:391; Count:2; Mnem:oc_FXCH7),
   {DF_4}
    (Base:391; Count:2; Mnem:oc_FXCH7),
   {DF_5}
    (Base:463; Count:2; Mnem:oc_FIST),
   {DF_6}
    (Base:397; Count:2; Mnem:oc_FSTP8),
   {DF_7}
    (Base:397; Count:2; Mnem:oc_FSTP8),
   {DF_8}
    (Base:463; Count:2; Mnem:oc_FISTP),
   {DF_9}
    (Base:397; Count:2; Mnem:oc_FSTP9),
   {DF_10}
    (Base:397; Count:2; Mnem:oc_FSTP9),
   {DF_11}
    (Base:465; Count:2; Mnem:oc_FBLD),
   {DF_12}
    (Base:467; Count:1; Mnem:oc_FNSTSW),
   {DF_13}
    (Base:467; Count:1; Mnem:oc_FSTSW),
   {DF_14}
    (Base:468; Count:2; Mnem:oc_FILD),
   {DF_15}
    (Base:419; Count:2; Mnem:oc_FUCOMIP),
   {DF_16}
    (Base:470; Count:2; Mnem:oc_FBSTP),
   {DF_17}
    (Base:419; Count:2; Mnem:oc_FCOMIP),
   {DF_18}
    (Base:432; Count:2; Mnem:oc_FISTP),
   {E0_0}
    (Base:472; Count:2; Mnem:oc_LOOPNZ),
    (Base:472; Count:2; Mnem:oc_LOOPNE),
   {E0_1}
    (Base:474; Count:2; Mnem:oc_LOOPNZ),
    (Base:474; Count:2; Mnem:oc_LOOPNE),
   {E1_0}
    (Base:472; Count:2; Mnem:oc_LOOPZ),
    (Base:472; Count:2; Mnem:oc_LOOPE),
   {E1_1}
    (Base:474; Count:2; Mnem:oc_LOOPZ),
    (Base:474; Count:2; Mnem:oc_LOOPE),
   {E2_0}
    (Base:472; Count:2; Mnem:oc_LOOP),
   {E2_1}
    (Base:474; Count:2; Mnem:oc_LOOP),
   {E3_0}
    (Base:476; Count:2; Mnem:oc_JCXZ),
    (Base:478; Count:2; Mnem:oc_JECXZ),
   {E3_1}
    (Base:478; Count:2; Mnem:oc_JECXZ),
    (Base:480; Count:2; Mnem:oc_JRCXZ),
   {E4_0}
    (Base:482; Count:2; Mnem:oc_IN),
   {E5_0}
    (Base:484; Count:2; Mnem:oc_IN),
   {E6_0}
    (Base:486; Count:2; Mnem:oc_OUT),
   {E7_0}
    (Base:488; Count:2; Mnem:oc_OUT),
   {E8_0}
    (Base:490; Count:2; Mnem:oc_CALL),
   {E9_0}
    (Base:492; Count:1; Mnem:oc_JMP),
   {EA_0}
    (Base:493; Count:1; Mnem:oc_JMPF),
   {EB_0}
    (Base:134; Count:1; Mnem:oc_JMP),
   {EC_0}
    (Base:494; Count:2; Mnem:oc_IN),
   {ED_0}
    (Base:496; Count:2; Mnem:oc_IN),
   {EE_0}
    (Base:498; Count:2; Mnem:oc_OUT),
   {EF_0}
    (Base:500; Count:2; Mnem:oc_OUT),
   {F0_0}
    (Mnem:oc_LOCK),
   {F1_1}
    (Base:352; Count:2; Mnem:oc_INT1),
    (Base:352; Count:2; Mnem:oc_ICEBP),
   {F2_0}
    (Base:502; Count:1; Mnem:oc_REPNZ),
    (Base:502; Count:1; Mnem:oc_REPNE),
   {F2_1}
    (Base:502; Count:1; Mnem:oc_REP),
   {F2_2}
    (Base:503; Count:1; Mnem:oc_REPNZ),
    (Base:503; Count:1; Mnem:oc_REPNE),
   {F2_3}
    (Base:503; Count:1; Mnem:oc_REP),
   {F3_0}
    (Base:502; Count:1; Mnem:oc_REPZ),
    (Base:502; Count:1; Mnem:oc_REPE),
   {F3_1}
    (Base:504; Count:1; Mnem:oc_REP),
   {F3_2}
    (Base:503; Count:1; Mnem:oc_REPZ),
    (Base:503; Count:1; Mnem:oc_REPE),
   {F3_3}
    (Base:503; Count:1; Mnem:oc_REP),
   {F4_0}
    (Mnem:oc_HLT),
   ...
   {F6_1}
    (Base:137; Count:2; Mnem:oc_TEST),
   {F6_2}
    (Base:505; Count:1; Mnem:oc_NOT),
   {F6_3}
    (Base:505; Count:1; Mnem:oc_NEG),
   {F6_4}
    (Base:506; Count:3; Mnem:oc_MUL),
   {F6_5}
    (Base:506; Count:3; Mnem:oc_IMUL),
   {F6_6}
    (Base:509; Count:4; Mnem:oc_DIV),
   {F6_7}
    (Base:509; Count:4; Mnem:oc_IDIV),
   {F7_0}
    (Base:513; Count:2; Mnem:oc_TEST),
   {F7_1}
    (Base:513; Count:2; Mnem:oc_TEST),
   {F7_2}
    (Base:515; Count:1; Mnem:oc_NOT),
   {F7_3}
    (Base:515; Count:1; Mnem:oc_NEG),
   {F7_4}
    (Base:516; Count:3; Mnem:oc_MUL),
   {F7_5}
    (Base:516; Count:3; Mnem:oc_IMUL),
   {F7_6}
    (Base:519; Count:3; Mnem:oc_DIV),
   {F7_7}
    (Base:519; Count:3; Mnem:oc_IDIV),
   {F8_0}
    (Mnem:oc_CLC),
   {F9_0}
    (Mnem:oc_STC),
   ...
   {FD_0}
    (Mnem:oc_STD),
   {FE_0}
    (Base:505; Count:1; Mnem:oc_INC),
   {FE_1}
    (Base:505; Count:1; Mnem:oc_DEC),
   {FF_0}
    (Base:515; Count:1; Mnem:oc_INC),
   {FF_1}
    (Base:515; Count:1; Mnem:oc_DEC),
   {FF_2}
    (Base:522; Count:2; Mnem:oc_CALL),
   {FF_3}
    (Base:524; Count:2; Mnem:oc_CALL),
   {FF_4}
    (Base:526; Count:2; Mnem:oc_CALLF),
   {FF_5}
    (Base:528; Count:1; Mnem:oc_JMP),
   {FF_6}
    (Base:529; Count:1; Mnem:oc_JMP),
   {FF_7}
    (Base:530; Count:1; Mnem:oc_JMPF),
   {FF_8}
    (Base:522; Count:2; Mnem:oc_PUSH),
   {FF_9}
    (Base:531; Count:2; Mnem:oc_PUSH)
  );

const
  OneByteArgs: array[0..532]of TOpcodeArg = (
   ...
   {A5_2 MOVSD}
    (Name:an_LrDIJ; Flags:[afDst,afNoDepend,afNoDispl]; A:am_Y; T:at_do),
    (Name:an_LrSIJ; Flags:[afNoDispl]; A:am_X; T:at_do),
   {A5_2 MOVSQ}
   ...
   {A7_2 CMPSW}
    ...
    (Name:an_LrSIJ; Flags:[afNoDispl]; A:am_X; T:at_wo),
   {A7_2 CMPSD}
    (Name:an_LrDIJ; Flags:[afNoDispl]; A:am_Y; T:at_do),
    (Name:an_LrSIJ; Flags:[afNoDispl]; A:am_X; T:at_do),
   {A7_2 CMPSQ}
